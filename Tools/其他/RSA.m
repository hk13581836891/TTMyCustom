...
//  Tian_IOS
//
//  Created by RichyLeo on 15/6/25.
...
+(NSDictionary*)encryptWithDESAndRSA:(NSData*) data withKey:(NSString*)key keyPath:(NSString*)keyPath{
    ...
    //rsa
    NSString* encryptedKey = [RSA RSAEncryptData:key keyPath:keyPath];
    
    //des
    NSData* encryptedData = [RSA DESEncrypt:data WithKey:key];
...
+(NSString*)RSAEncryptData:(NSString*)text keyPath:(NSString*)keyPath{
    NSData* data = [RSA RSAEncryptToData:text keyPath:keyPath];
...
+(NSString*)DESEncryptWithBase64:(NSString*)str key:(NSString*)key{
    ...
    NSData* encryptData = [RSA DESEncrypt:data WithKey:key];
...
+(NSString*)DESDecryptBase64:(NSString*)base64 key:(NSString*)key{
    ...
    NSData* data = [RSA DESDecrypt:encryptData WithKey:key];
